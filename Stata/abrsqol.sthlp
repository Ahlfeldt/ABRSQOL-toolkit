...
{title:Example 3:} 
Increases income share on non-housing consumption to 0.8 and increases convergence parameter to 0.5
    
ABRSQOL MyQOLmeasure w p_H P_t p_n L L_b "alpha=0.8" "conv=0.5"
