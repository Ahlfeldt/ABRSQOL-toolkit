...
| MATLAB | Example.m | Illustrative script that reads the test data set and calls the ABRSQOL funcation with an exemplary syntax. Just open the do file in MATLAB after you have copied it from the MATLAB folder and take it from there. |
